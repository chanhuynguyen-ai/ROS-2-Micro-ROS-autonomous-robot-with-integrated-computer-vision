...
setup(
    ...
    entry_points={
        'console_scripts': [
            'PD_controller_v3 = avs_controlsystem.PD_controller_v3:main',
            'PD_controller_v2 = avs_controlsystem.PD_controller_v2:main',
            "PD_controller_v1 = avs_controlsystem.PD_controller_v1:main",
            'main_following_pd = avs_controlsystem.main_following_pd_node:main',
