...
class PDBacksteppingControllerV2(Node):
    ...
    VERSION = "pd_backstepping_v2_smooth_early_2_4"
    ...
    def compute_tracking(
        ...
        # V2_4_CENTER_HARD_ZERO
        #
        # Khi xe đã vào center zone, steering target phải thực sự
        # trở về zero. omega_ref vẫn được slew về zero bởi
        # omega_rate_center nên không bị giật.
        if curve_zone == "center":
            omega_des = 0.0
