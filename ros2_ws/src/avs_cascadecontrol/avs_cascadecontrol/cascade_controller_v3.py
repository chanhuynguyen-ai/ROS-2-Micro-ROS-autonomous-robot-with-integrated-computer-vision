...
class CascadeControllerV3(Node):

    VERSION = (
        "cascade_controller_v3_"
    ...
    def __init__(self):
        ...
        self.declare_parameter(
            "ref_topic",
            "/avs/cascade_controller_v3_ref"
        )

        self.declare_parameter(
            "state_topic",
            "/avs/cascade_controller_v3_state"
        )
        ...
        # Giảm trọng số kappa vì kappa hay bị noise
        self.declare_parameter(
            "curve_kappa_weight",
            0.10
        )
