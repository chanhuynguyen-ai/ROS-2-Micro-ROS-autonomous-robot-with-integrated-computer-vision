...
def generate_launch_description():
    ...
    config = os.path.join(pkg, "config", "cascade_controller_v1.yaml")
    ...
    return LaunchDescription([
        ...
        LogInfo(msg=[
            "cascade_controller_v1 launch. enable_cmd=",
        ...
        Node(
            ...
            executable="cascade_controller_v1",
            name="cascade_controller_v1",
            output="screen",
            parameters=[
                config,
                {
